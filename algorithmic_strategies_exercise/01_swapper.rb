...
#establish method, arr and 2 indices
def swapper (arr,ele_1,ele_2)

    # switch two indices w/ each other
    arr[ele_1], arr[ele_2] = arr[ele_2], arr[ele_1]
    
    # give back the new arr
    return arr
end
